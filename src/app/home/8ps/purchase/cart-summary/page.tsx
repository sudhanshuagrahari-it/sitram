...
export default function CartSummaryPage() {
  ...
  const [step, setStep] = useState<'userinfo' | 'summary'>("userinfo");
      ...
      <div className="max-w-xl w-full bg-white/80 rounded-2xl shadow-2xl p-8 mt-10 mb-10">
        ...
        {step === "summary" && (
          <>
            ...
            <button className="fancy-btn bg-green-500 text-white px-6 py-2 rounded-full font-bold shadow hover:bg-green-600 transition mt-4">Confirm & Place Order</button>
          </>
        )}
      </div>
    </div>
